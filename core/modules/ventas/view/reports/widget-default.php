...
<div class="well">
		<table class="table table-bordered">
				<thead>
					<tr>
						<th>Fecha de incio <a href="#" class="btn btn-sm btn-default" id="dp4" data-date-format="yyyy-mm-dd" data-date="2020-11-29">Cambiar</a></th>
						<th>Fecha de fin <a href="#" class="btn btn-sm btn-default" id="dp5" data-date-format="yyyy-mm-dd" data-date="2020-11-30">Cambiar</a></th>
						<th></th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td id="startDate">2020-11-29</td>
						<td id="endDate">2020-11-30</td>
						<td id="">
						<form>
